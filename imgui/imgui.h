...
namespace ImGui
{
    ...
    IMGUI_API bool MenuChild(const char* str_id, const ImVec2& size_arg, bool sub_tab, ImGuiWindowFlags extra_flags);
...
struct ImDrawList
{
    ...
    //IMGUI_API  void InjectButton(const ImVec2& p_min, const ImVec2& p_max, ImU32 col_upr_left, ImU32 col_upr_right, ImU32 col_bot_right, ImU32 col_bot_left, float rounding, ImDrawCornerFlags rounding_corners);
